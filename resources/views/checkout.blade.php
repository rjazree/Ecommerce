							...
							<form action="#" id="checkout_form" class="checkout_form">
								...
								<div class="checkout_extra">
									<div>
										...
										<label for="checkbox_terms"><img src="img/check.png" alt=""></label>
									...
									<div>
										...
										<label for="checkbox_account"><img src="img/check.png" alt=""></label>
									...
									<div>
										...
										<label for="checkbox_newsletter"><img src="img/check.png" alt=""></label>
